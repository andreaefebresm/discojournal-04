<template>
  <nav class="topbar">
    ...
    <div class="navlinks">
      <button type="button" aria-label="Issues — numeri precedenti" @click.prevent>
...
// menu dietro ancora, da decidere insieme.
</script>
...
.navlinks a:hover, .navlinks a:focus-visible{ transform: translateY(-2px) scale(1.06); }
.navlinks button img, .navlinks a img{
  height:100%; width:auto; display:block;
  filter: drop-shadow(0 4px 8px rgba(10,25,35,0.35));
}
</style>
