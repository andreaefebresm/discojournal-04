declare global {
  ...
  const getContentfulClient: typeof import('../../server/utils/contentful').getContentfulClient
  ...
  const mapAboutEntry: typeof import('../../server/utils/contentful').mapAboutEntry
  const mapHouseEntry: typeof import('../../server/utils/contentful').mapHouseEntry
  const mapIssueEntry: typeof import('../../server/utils/contentful').mapIssueEntry
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Users/andreaelenafebresmedina/Desktop/discojournal-04/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/Users/andreaelenafebresmedina/Desktop/discojournal-04/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { useAppConfig } from '/Users/andreaelenafebresmedina/Desktop/discojournal-04/node_modules/@nuxt/nitro-server/dist/runtime/utils/app-config';
export { getContentfulClient, mapHouseEntry, mapAboutEntry, mapIssueEntry } from '/Users/andreaelenafebresmedina/Desktop/discojournal-04/server/utils/contentful';