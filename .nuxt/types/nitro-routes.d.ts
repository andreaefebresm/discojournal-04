...
declare module "nitropack/types" {
  ...
  interface InternalApi {
    '/api/about': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/about.get').default>>>>
    }
    '/api/houses': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/houses.get').default>>>>
    }
    '/api/houses/:slug': {
