...
const assets = {
  "/index.mjs": {
    ...
    "etag": "\"1f036-KUKuekrYfRahGqF0EWLA+TbgGgo\"",
    "mtime": "2026-09-13T17:04:41.619Z",
    "size": 127030,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"7666a-DJIAUaatrtZZl8ip16EFCVMse8k\"",
    "mtime": "2026-09-13T17:04:41.619Z",
    "size": 484970,
    "path": "index.mjs.map"
  }
...
function getContentfulClient() {
  ...
  const accessToken = config.contentfulToken;
...
function mapHouseEntry(entry) {
  var _a, _b, _c, _d, _e;
  const f = entry.fields;
  const asset = (_a = f.houseImage) == null ? void 0 : _a.fields;
  return {
    slug: f.slug,
    number: f.number,
    title: f.title,
    ...
    image: asset ? {
      ...
      width: ((_c = (_b = asset.file.details) == null ? void 0 : _b.image) == null ? void 0 : _c.width) || 1200,
      height: ((_e = (_d = asset.file.details) == null ? void 0 : _d.image) == null ? void 0 : _e.height) || 654
    } : null,
...
function mapIssueEntry(entry) {
  var _a, _b, _c, _d, _e, _f;
  const f = entry.fields;
  const asset = (_a = f.screenshot) == null ? void 0 : _a.fields;
  return {
    number: f.number,
    title: f.title || `Issue ${(_b = f.number) != null ? _b : ""}`,
    image: asset ? {
      url: asset.file.url.startsWith("//") ? "https:" + asset.file.url : asset.file.url,
      width: ((_d = (_c = asset.file.details) == null ? void 0 : _c.image) == null ? void 0 : _d.width) || 1200,
      height: ((_f = (_e = asset.file.details) == null ? void 0 : _e.image) == null ? void 0 : _f.height) || 750
    } : null,
    url: f.url || null
  };
}
...
var body = [
	"## DiSCo Journal",
	"Segnaposto: qui andrà il testo di presentazione della rivista — chi è DiSCo, di cosa parla, come è organizzata per numeri.",
	"Testo segnaposto con **testo in grassetto** e *testo in corsivo*, da sostituire con il contenuto reale da Contentful."
];
const sample$2 = {
	title: title,
	body: body
...
const about_get = defineEventHandler(async (event) => {
  const client = getContentfulClient();
  if (!client) return sample$2;
  try {
...
const about_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: about_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const sample$1 = [
	{
		slug: "charlotte-schuitenmaker",
		number: 1,
		title: "Charlotte Schuitenmaker",
		excerpt: "Pratiche musicali urbane indigene australiane.",
		image: {
			url: "/assets/islands/island1_charlotte.png",
			width: 2400,
			height: 1792
		},
		body: [
			"## Nota redazionale",
			"> Segnaposto: qui andrà l'estratto o la citazione chiave dell'articolo, in evidenza.",
			"Testo segnaposto dell'articolo 01 con **testo in grassetto** e *testo in corsivo*, da sostituire con il contenuto reale da Contentful."
		]
	},
	{
		slug: "fareda-el-shaaer",
		number: 2,
		title: "Fareda El Shaaer",
		excerpt: "Accento egiziano, tecnologie di riconoscimento vocale e identità diasporica.",
		image: {
			url: "/assets/islands/island2_fareda.png",
			width: 2400,
			height: 1792
		},
		body: [
			"## Nota redazionale",
			"> Segnaposto: qui andrà l'estratto o la citazione chiave dell'articolo, in evidenza.",
			"Testo segnaposto dell'articolo 02 con **testo in grassetto** e *testo in corsivo*, da sostituire con il contenuto reale da Contentful."
		]
	},
	{
		slug: "april-wei-west",
		number: 3,
		title: "April Wei-West",
		excerpt: "Comunità online di vocal synth e affordance delle piattaforme di ascolto (ricerca sul campo in Giappone).",
		image: {
			url: "/assets/islands/island3_april.png",
			width: 2400,
			height: 1792
		},
		body: [
			"## Nota redazionale",
			"> Segnaposto: qui andrà l'estratto o la citazione chiave dell'articolo, in evidenza.",
			"Testo segnaposto dell'articolo 03 con **testo in grassetto** e *testo in corsivo*, da sostituire con il contenuto reale da Contentful."
		]
	},
	{
		slug: "nicole-furtado",
		number: 4,
		title: "Nicole Furtado",
		excerpt: "Racconto sf su scarsità d'acqua e IA, ispirato alle Hawaii.",
		image: {
			url: "/assets/islands/island4_nicole.png",
			width: 2400,
			height: 1792
		},
		body: [
			"## Nota redazionale",
			"> Segnaposto: qui andrà l'estratto o la citazione chiave dell'articolo, in evidenza.",
			"Testo segnaposto dell'articolo 04 con **testo in grassetto** e *testo in corsivo*, da sostituire con il contenuto reale da Contentful."
		]
	},
	{
		slug: "crassula-shang",
		number: 5,
		title: "Crassula Shang",
		excerpt: "Chinese Cyberfeminism Archive.",
		image: {
			url: "/assets/islands/island5_crassula.png",
			width: 1200,
			height: 896
		},
		body: [
			"## Nota redazionale",
			"> Segnaposto: qui andrà l'estratto o la citazione chiave dell'articolo, in evidenza.",
			"Testo segnaposto dell'articolo 05 con **testo in grassetto** e *testo in corsivo*, da sostituire con il contenuto reale da Contentful."
		]
	},
	{
		slug: "the-editors",
		number: 6,
		title: "The Editors",
		excerpt: "Note editoriali del team di DiSCo Journal per questo numero.",
		image: {
			url: "/assets/islands/island6_editors.png",
			width: 1200,
			height: 896
		},
		body: [
			"## Nota redazionale",
			"> Segnaposto: qui andrà l'editoriale del team, l'estratto/citazione chiave in evidenza.",
			"Testo segnaposto dell'articolo degli editors con **testo in grassetto** e *testo in corsivo*, da sostituire con il contenuto reale da Contentful."
		]
	}
];

const houses_get = defineEventHandler(async (event) => {
  const client = getContentfulClient();
  let houses;
  if (!client) {
    houses = sample$1;
    ...
    try {
      const res = await client.getEntries({ content_type: "article", order: ["fields.number"] });
      houses = res.items.map(mapHouseEntry).filter((h) => h.published);
    } catch (err) {
      console.error("[api/houses] fetch Contentful fallito, uso i dati di esempio:", err);
      houses = sample$1;
    }
  }
  const withLayout = houses.map((h) => {
...
const houses_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: houses_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const _slug__get = defineEventHandler(async (event) => {
  ...
  try {
    const res = await client.getEntries({ content_type: "article", "fields.slug": slug, limit: 1 });
    const item = res.items[0];
...
const sample = [
	...
	},
	{
		...
		title: "Issue 2",
		image: {
			url: "/assets/issues/issue2.png",
			width: 3102,
			height: 1884
		},
		url: "https://discojournal.github.io/archive/"
	},
	{
		number: 1,
		title: "Issue 1",
		image: {
			url: "/assets/issues/issue1.png",
			width: 3102,
			height: 1884
		},
		url: "https://discojournal.github.io/archive/index.html?p=228.html"
	}
];
...
const issues_get = defineEventHandler(async (event) => {
  ...
  try {
    const res = await client.getEntries({ content_type: "issue", order: ["-fields.number"] });
    if (!res.items.length) {
